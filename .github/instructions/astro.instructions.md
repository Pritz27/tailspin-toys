...
- Define a `Props` interface in frontmatter and add a concise TSDoc comment describing the component's public contract, including non-obvious prop requirements.
...
- Comment why a component needs non-obvious markup or behavior, not what the markup already expresses. Remove or update stale comments when the component changes.
